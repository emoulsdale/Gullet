...
func _run_test_method(test_file: Node, test_method: String) -> void:
...
func run_all_tests() -> void:
	...
	for test_file_path in test_file_paths:
		_run_all_test_methods_in_file(test_file_path)
