...
func report_pass() -> void:
	emit_signal("test_passed", current_test_file_path, current_test_method)
...
func setup_test_file(test_file_path: String) -> Node:
...
func run_tests_in_file(test_file_path: String) -> void:
	var test_file := setup_test_file(test_file_path)
